...
import lojainformatica.persistence.ClienteHibernateDAO;
import lojainformatica.persistence.HibernateUtil;
...
/*
	...
	*/
	public static void main(String[] args) {
		...
		c2.setEndereco("R. Arvores");
		c2.setFone("15");
		
		
	//	Cliente c2 = new Cliente();
	//	c2.setNome("Alexandre");
	//	c2.setEndereco("R. Arvore do Dragao");
	//	c2.setFone("2514-5455");
		...
		clienteDao.persistir(c2);
	//	clienteDao.excluir(7);
		clienteDao.commit();
